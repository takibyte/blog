...
![pi installer](./images/installer2.webp)
...
![router config](./images/config1.webp)
...
![router config](./images/config2.webp)
...
![router config](./images/config3.webp)
...
![pi installer](./images/installer4.webp)
...
![pi installer](./images/installer6.webp)
...
![pi installer](./images/installer7.webp)
...
![pi installer](./images/installer8.webp)
...
![pi installer](./images/installer9.webp)

![pi installer](./images/installer10.webp)
...
![router config](./images/config4.webp)

Anyway, let's begin by configuring option one first. Heading back over to my router's admin panel now, we can see that there is a DNS section under network settings. 
...
![pihole web](./images/pihole2.webp)
...
1. Total queries: here we can see how many domains are being queried, and how many clients are connected. If we were to click through here we would see all the query URLs, and which client they are coming from. At the moment, there are only 2 clients connected: the router and the Pi.
...
![pihole web](./images/pihole3.webp)
...
![router config](./images/config5.webp)
...
![pihole web](./images/pihole4.webp)
...
![router config](./images/config6.webp)
